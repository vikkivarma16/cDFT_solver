...
# ============================================================
# POLYMER density sweep
# ============================================================

# total polymer density range
rho_polymer_total_vals = np.linspace(0.54, 0.8, 10)
...
print("\nStarting polymer-density scan...\n")

for rho_total in tqdm(
    rho_polymer_total_vals,
    desc="Scanning polymer densities"
):

    # --------------------------------------------------------
    # Split total polymer density equally
    # --------------------------------------------------------
    ...
    try:
        ...
        print(f"\nFailed at total polymer density = {rho_total:.6f}")
        print(e)
